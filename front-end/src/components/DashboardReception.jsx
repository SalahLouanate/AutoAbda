  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-0.5 min-w-0 w-full">
        ...
        <h3 className="text-sm sm:text-base font-bold text-slate-800 leading-tight truncate">{marqueDisplay}</h3>
...
export default function DashboardReception() {
  ...
  return (
    <div className="flex flex-col gap-4 sm:gap-6 min-h-full font-sans w-full p-2 sm:p-0">
      {/* Page Header (100% largeur disponible, responsive) */}
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-4 sm:p-6 rounded-2xl border border-gray-200 shadow-sm">
        <div>
          <h1 className="text-xl sm:text-2xl font-extrabold text-slate-800 tracking-tight flex items-center gap-3">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-3 flex-wrap">
          <span className="inline-flex items-center justify-center gap-2 px-3 py-2 sm:px-3.5 sm:py-2 rounded-full bg-emerald-50 text-emerald-700 text-xs font-bold border border-emerald-200">
            <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse" />
            Réception Ouverte
          </span>

          <span className="inline-flex items-center justify-center gap-1.5 px-3 py-2 sm:px-3.5 sm:py-2 rounded-full bg-slate-100 text-slate-600 text-xs font-bold border border-slate-200">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        ...
        <div className="bg-amber-50/60 p-3.5 sm:p-4 rounded-xl border border-amber-200/80 shadow-xs">
          <p className="text-[10px] sm:text-xs font-semibold text-amber-700 uppercase">En Attente</p>
          <p className="text-xl sm:text-2xl font-black text-amber-800 mt-1">{kpis.en_attente}</p>
        </div>
        <div className="bg-blue-50/60 p-3.5 sm:p-4 rounded-xl border border-blue-200/80 shadow-xs">
          <p className="text-[10px] sm:text-xs font-semibold text-blue-700 uppercase">En Cours</p>
          <p className="text-xl sm:text-2xl font-black text-blue-800 mt-1">{kpis.en_cours}</p>
        </div>
        <div className="bg-emerald-50/60 p-3.5 sm:p-4 rounded-xl border border-emerald-200/80 shadow-xs">
          <p className="text-[10px] sm:text-xs font-semibold text-emerald-700 uppercase">Clôturés</p>
          <p className="text-xl sm:text-2xl font-black text-emerald-800 mt-1">{kpis.termines}</p>
        </div>
      </div>
      ...
      <div className="w-full flex flex-col gap-4">
        ...
        {vehiculesFiltres.length === 0 ? (
          <div className="p-8 sm:p-16 text-center bg-white rounded-2xl border border-dashed border-gray-300 text-slate-400 flex flex-col items-center justify-center gap-2 mx-0">
            ...
            <p className="text-sm sm:text-base font-bold text-slate-700">Aucun véhicule dans cette catégorie ({filterTab})</p>
