...
export default function ReceptionLayout() {
  ...
  return (
    <div className="flex h-screen bg-gray-50 font-sans">
      ...
      {/* ── Sidebar ── */}
      <aside className="fixed top-0 left-0 h-[100dvh] w-64 bg-slate-900 flex flex-col z-40 border-r border-slate-700/50">
      ...
      <main className="ml-64 flex-1 overflow-y-auto">
        ...
        <div className="sticky top-0 z-30 bg-gray-50/90 backdrop-blur-sm border-b border-slate-200/80 px-8 py-4 flex items-center gap-3">
          <div className="flex items-center gap-2 text-slate-400 text-sm">
            <span className="font-medium text-yellow-500 text-xs uppercase tracking-widest">Réception</span>
            <span>/</span>
